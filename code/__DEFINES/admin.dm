...
#define ADMIN_FULLMONTY_NONAME(user) "[ADMIN_QUE(user)] [ADMIN_PM(user)] [ADMIN_PP(user)] [ADMIN_VV(user)] [ADMIN_SM(user)] [ADMIN_FLW(user)] [ADMIN_TP(user)] [ADMIN_INDIVIDUALLOG(user)] [ADMIN_SMITE(user)] [ADMIN_PLAYEREFFECTS(user)]" //OV EDIT
...
#define ADMIN_PLAYEREFFECTS(user) "(<a href='?_src_=holder;[HrefToken(TRUE)];adminplayereffects=[REF(user)]'>PE</a>)" //OV ADD
